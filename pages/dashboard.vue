<template>
  <section>
    <!--begin::Content-->
    <div id="kt_content" class="content pos@relative d-flex flex-column flex-column-fluid">
      <!--begin::Subheader-->
      <div id="kt_subheader" class="subheader py-2 py-lg-12  subheader-transparent ">
          ...
          <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">
              ...
              <div class="d-flex align-items-center font-weight-bold my-2">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <span class="label label-dot label-sm bg-white opacity-75 mx-3" />
              ...
              <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 py-5">
                  <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted mt-3 font-weight-bold font-size-sm">Total List of Products from the Latest additions</span>
                  </h3>
                      ...
                      <tbody>
                        <tr v-for="(product, index) in products" :key="index">
                          ...
                          <td class="pr-0">
                            <div class="symbol symbol-50 symbol-light mt-1">
                              <span class="symbol-label">
                                <img :src="product.productImage" class="h-75 align-self-end" alt="">
                              </span>
                            </div>
                          </td>
                          <td class="pl-0">
                            ...
                            >{{ product.title }}</a>
                            <span class="text-muted font-weight-bold text-muted d-block">N{{ product.price }} per Bag</span>
                          </td>
                          <!--<td>
                          ...
                          <!--<td class="pr-0 text-right">
                            ...
                            >
                              <span class="svg-icon svg-icon-md svg-icon-primary">&lt;!&ndash;begin::Svg Icon | path:assets/media/svg/icons/General/Settings-1.svg&ndash;&gt;<svg
                                xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px"
                                height="24px"
                              ...
                              </svg>&lt;!&ndash;end::Svg Icon&ndash;&gt;</span> </a>
                            <a
                              href="#"
                              class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3"
                            >
                              <span class="svg-icon svg-icon-md svg-icon-primary">&lt;!&ndash;begin::Svg Icon | path:assets/media/svg/icons/Communication/Write.svg&ndash;&gt;<svg
                                xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px"
                                height="24px"
                            ...
                            <a
                              ...
                              class="btn btn-icon btn-light btn-hover-primary btn-sm"
                            >
                              <span class="svg-icon svg-icon-md svg-icon-primary">&lt;!&ndash;begin::Svg Icon | path:assets/media/svg/icons/General/Trash.svg&ndash;&gt;<svg
                                xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px"
                                height="24px"
    ...
    <div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
      ...
      <div class="offcanvas-content px-10">
        <div class="tab-content">
          <!--begin::Tabpane-->
          <div id="kt_quick_panel_logs" class="tab-pane fade show pt-3 pr-5 mr-n5 active" role="tabpanel">
            <!--begin::Section-->
            <div class="mb-15">
          ...
          <!--begin::Tabpane-->
          <div id="kt_quick_panel_notifications" class="tab-pane fade pt-2 pr-5 mr-n5" role="tabpanel">
            <!--begin::Nav-->
            <div class="navi navi-icon-circle navi-spacer-x-0">
              ...
              <a href="#" class="navi-item">
                <div class="navi-link rounded">
                  <div class="symbol symbol-50 mr-3">
                    <div class="symbol-label"><i class="flaticon-bell text-success icon-lg" /></div>
                  </div>
                  <div class="navi-text">
              ...
              <a href="#" class="navi-item">
                <div class="navi-link rounded">
                  <div class="symbol symbol-50 mr-3">
                    <div class="symbol-label"><i class="flaticon2-box text-danger icon-lg" /></div>
                  </div>
                  <div class="navi-text">
                    <div class="font-weight-bold  font-size-lg">
              ...
              <a href="#" class="navi-item">
                <div class="navi-link rounded">
                  <div class="symbol symbol-50 mr-3">
                    <div class="symbol-label"><i class="flaticon-psd text-primary icon-lg" /></div>
                  </div>
                  <div class="navi-text">
                    <div class="font-weight-bold  font-size-lg">
              ...
              <a href="#" class="navi-item">
                <div class="navi-link rounded">
                  <div class="symbol symbol-50 mr-3">
                    <div class="symbol-label"><i class="flaticon2-supermarket text-warning icon-lg" />
                    </div>
                  </div>
                  <div class="navi-text">
                    <div class="font-weight-bold  font-size-lg">
              ...
              <a href="#" class="navi-item">
                <div class="navi-link rounded">
                  <div class="symbol symbol-50 mr-3">
                    <div class="symbol-label"><i class="flaticon-paper-plane-1 text-success icon-lg" />
                    </div>
                  </div>
                  <div class="navi-text">
                    <div class="font-weight-bold  font-size-lg">
              ...
              <a href="#" class="navi-item">
                <div class="navi-link rounded">
                  <div class="symbol symbol-50 mr-3">
                    <div class="symbol-label"><i class="flaticon-notepad text-primary icon-lg" /></div>
                  </div>
                  <div class="navi-text">
                    <div class="font-weight-bold  font-size-lg">
              ...
              <a href="#" class="navi-item">
                <div class="navi-link rounded">
                  <div class="symbol symbol-50 mr-3">
                    <div class="symbol-label"><i class="flaticon-users-1 text-warning icon-lg" /></div>
                  </div>
                  <div class="navi-text">
                    <div class="font-weight-bold  font-size-lg">
              ...
              <a href="#" class="navi-item">
                <div class="navi-link rounded">
                  <div class="symbol symbol-50 mr-3">
                    <div class="symbol-label"><i class="flaticon2-box text-info icon-lg" /></div>
                  </div>
                  <div class="navi-text">
                    <div class="font-weight-bold  font-size-lg">
              ...
              <a href="#" class="navi-item">
                <div class="navi-link rounded">
                  <div class="symbol symbol-50 mr-3">
                    <div class="symbol-label"><i class="flaticon2-download text-success icon-lg" /></div>
                  </div>
                  <div class="navi-text">
                    <div class="font-weight-bold  font-size-lg">
              ...
              <a href="#" class="navi-item">
                <div class="navi-link rounded">
                  <div class="symbol symbol-50 mr-3">
                    <div class="symbol-label"><i class="flaticon2-supermarket text-danger icon-lg" />
                    </div>
                  </div>
                  <div class="navi-text">
                    <div class="font-weight-bold  font-size-lg">
              ...
              <a href="#" class="navi-item">
                <div class="navi-link rounded">
                  <div class="symbol symbol-50 mr-3">
                    <div class="symbol-label"><i class="flaticon-bell text-primary icon-lg" /></div>
                  </div>
                  <div class="navi-text">
                    <div class="font-weight-bold  font-size-lg">
          ...
          <!--begin::Tabpane-->
          <div id="kt_quick_panel_settings" class="tab-pane fade pt-3 pr-5 mr-n5" role="tabpanel">
            <form class="form">
              <!--begin::Section-->
              <div>
...
<script>
import img from '@/assets/media/bg/bg-10.jpg'
import AddProductModal from '~/components/add-prduct-modal'
